...
function Cursor() {
    ...
    if ($[0] !== "a05897051ba4f120e6deb03fca360b1c5d77efdd6bcd02ef94ba0748f5e447f3") {
        for(let $i = 0; $i < 4; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "a05897051ba4f120e6deb03fca360b1c5d77efdd6bcd02ef94ba0748f5e447f3";
    }
            ...
            "Cursor[useEffect()]": ()=>{
                const move = {
                    "Cursor[useEffect() > move]": (e)=>{
                        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__$3c$export__default__as__gsap$3e$__["gsap"].to(cursor.current, {
                            x: e.clientX - 12,
                            y: e.clientY - 12,
                            duration: 0.2,
                            ease: "power3.out"
...
_s(Cursor, "YKUQBO1sI8C2WH21bMdnigbD5Vs=");
_c = Cursor;
var _c;
...
//# sourceMappingURL=src_54ce52d6._.js.map